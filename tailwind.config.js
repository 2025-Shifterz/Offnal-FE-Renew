...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // 줄 높이 정의
      lineHeight: {
        'h-heading-xxxxs': 'var(--line-height-heading-xxxxs)',
        'h-heading-xxxs': 'var(--line-height-heading-xxxs)',
        'h-heading-xxs': 'var(--line-height-heading-xxs)',
        'h-heading-xs': 'var(--line-height-heading-xs)',
        'h-heading-s': 'var(--line-height-heading-s)',
        'h-heading-m': 'var(--line-height-heading-m)',
        'h-heading-l': 'var(--line-height-heading-l)',
        'h-heading-xl': 'var(--line-height-heading-xl)',

        'h-body-xxxs': 'var(--line-height-body-xxxs)',
        'h-body-xxs': 'var(--line-height-body-xxs)',
        'h-body-xs': 'var(--line-height-body-xs)',
        'h-body-s': 'var(--line-height-body-s)',
        'h-body-m': 'var(--line-height-body-m)',
        'h-body-l': 'var(--line-height-body-l)',
        'h-body-xl': 'var(--line-height-body-xl)',

        'h-label-xxxs': 'var(--line-height-label-xxxs)',
        'h-label-xxs': 'var(--line-height-label-xxs)',
        'h-label-xs': 'var(--line-height-label-xs)',
        'h-label-s': 'var(--line-height-label-s)',
        'h-label-m': 'var(--line-height-label-m)',
        'h-label-l': 'var(--line-height-label-l)',
      },
